...
import type { GuestItem, DietaryTag, AccessTag, RSVPStatus } from "@/types/api";
...
export default function GuestManagement() {
  ...
  // TODO: Replace with API call to fetch guests for this event
  const [rows, setRows] = useState<GuestItem[]>([]);
