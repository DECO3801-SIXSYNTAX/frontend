...
import { UnifiedAuthService, User } from '../services/UnifiedAuthService';
...
const GoogleButton: React.FC<GoogleButtonProps> = ({
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      Logger.info('Initiating Google Sign-In with Firebase popup');

      // Gunakan Firebase signInWithPopup langsung
